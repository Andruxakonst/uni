...
return [
   ...
   "https" => true,
   "private_hash" => "2b041ac127efd8862025e026176713d3",
   "private_hex" => "6a3d8c8539b97eeb58e2e5177ca240f1",
   "feed_ads_key" => "41492764",
   "cron_key" => "65520710",
   "folder_admin" => "cp_62c018e9bc54b",
   "basePath" => __dir__,

   "urlPrefix" => "/",
   "urlPath" => "https://crowdfaster.com",
   ...
   "js_plugins" => [
        ...
        [ 'ad_view'=> ['js/view.js','js/ui/jquery-ui.min.js'] ],
