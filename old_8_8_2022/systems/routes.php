...
Router::route('user/([a-zA-Z0-9\-]+)/ads_import', function($id_user){
    require 'modules/ads_import/index.php';
});

Router::route('user/([a-zA-Z0-9\-]+)/include/modules/ads_import/script.js', function(){
    require 'modules/ads_import/script.js';
});
