...
$searchUsers = getAll("SELECT * FROM uni_clients WHERE clients_email LIKE '%$q%' or clients_phone LIKE '%$q%' or clients_name LIKE '%$q%' or clients_surname LIKE '%$q%' Order by clients_name ASC");
