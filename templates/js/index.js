$(document).ready(function () {
   ...
   function loadContentIndex(){
        ...
        $.ajax({type: "POST",url: url_path + "systems/ajax/ads.php",data: "action=load_content_index",dataType: "html",cache: false,success: function (data) { 
            
            $(".load-content-index-container").html(data);
