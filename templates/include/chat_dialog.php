  ...
  <div class="module-chat-dialog-footer-box1" >
		...
		<div class="chat-dialog-text-flex-box" >
			 ...
			 <div class="chat-dialog-text-flex-box3" >
					...
					<div class="chat-dialog-audio-start" >
			 			<svg width="24" height="24" fill="none" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" clip-rule="evenodd" d="M7.1 6.9a4.9 4.9 0 019.8 0v4.2a4.9 4.9 0 11-9.8 0V6.9zM12 3.8a3.1 3.1 0 00-3.1 3.1v4.2a3.1 3.1 0 106.2 0V6.9A3.1 3.1 0 0012 3.8z" fill="currentColor"></path><path d="M19.68 15.35a.9.9 0 00-1.56-.9A7.06 7.06 0 0112 18a7.06 7.06 0 01-6.12-3.55.9.9 0 10-1.56.9 8.87 8.87 0 006.78 4.4v2.35a.9.9 0 101.8 0v-2.35a8.87 8.87 0 006.78-4.4z" fill="currentColor"></path></svg>
			 		</div>
	...
	<div class="module-chat-dialog-footer-box2" >

		<div class="chat-dialog-audio-flex-box" >
			 <div class="chat-dialog-audio-flex-box1" >

					<div class="chat-dialog-audio-cancel" >
			 			<svg height="24" viewBox="16 20 24 24" width="24" xmlns="http://www.w3.org/2000/svg" stroke="#828a99" fill="none" stroke-linecap="round" stroke-width="2.5"><path d="m22.5 26.5 11 11"/><path d="m33.5 26.5-11 11"/></svg>
			 		</div>

			 </div>
			 <div class="chat-dialog-audio-flex-box2" >

					<div class="chat-dialog-audio-container" ><div class="audio-column-line" ></div></div>

			 </div>
			 <div class="chat-dialog-audio-flex-box3" >

					<div class="chat-dialog-audio-timer" ><span>00:00</span></div>

			 </div>
			 <div class="chat-dialog-audio-flex-box4" >

					<div class="chat-dialog-audio-send" >
			 			<svg width="24" height="24" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd"><g id="send_24__send_24"><path id="send_24__Rectangle-76" d="M0 0h24v24H0z"></path><path d="M5.74 15.75a39.14 39.14 0 00-1.3 3.91c-.55 2.37-.95 2.9 1.11 1.78 2.07-1.13 12.05-6.69 14.28-7.92 2.9-1.61 2.94-1.49-.16-3.2C17.31 9.02 7.44 3.6 5.55 2.54c-1.89-1.07-1.66-.6-1.1 1.77.17.76.61 2.08 1.3 3.94a4 4 0 003 2.54l5.76 1.11a.1.1 0 010 .2L8.73 13.2a4 4 0 00-3 2.54z" id="send_24__Mask" fill="currentColor"></path></g></g></svg>
			 		</div>
		...
		<audio autoplay="false" src="" type="audio/mp3" ></audio>
