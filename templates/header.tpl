<header class="header-wow d-none d-lg-block" >
           ...
           <div class="row" >
               ...
               <div class="col-lg-6 col-6 text-right" >
                    ...
                    <div class="toolbar-link mr8" >
                        ...
                        <a <?php if($settings["marketplace_view_cart"] == 'modal'){ echo 'class="toolbar-link-title-icon open-modal" data-id-modal="modal-cart"'; }elseif($settings["marketplace_view_cart"] == 'sidebar'){ echo 'class="toolbar-link-title-icon sidebar-cart-open"'; }elseif($settings["marketplace_view_cart"] == 'page'){ echo 'href="'._link('cart').'"'; } ?>  >
                            <div class="toolbar-link-title-icon-box" >
   ...
   <div class="header-wow-sticky" >
       ...
       <div class="container" >
         	<div class="row">
             	<div class="col-lg col-md col-sm text-center m-2" >
          ...
          <div class="row no-gutters" >
             <div class="col-lg-4" >
                 ...
                 <?php
                    ...
                    if(count($data["category"]["category_board_id_parent"][0])){
               ...
               <div class="header-flex-box-2" >
                  ...
                  <div class="container-search-goods parents-ajax-live-search" >
                      ...
                      <div class="header-wow-sticky-search" >
                          ...
                          <form class="form-ajax-live-search" method="get" action="<?php if($route_name != 'map'){ echo $_SESSION["geo"]["alias"] ? _link($_SESSION["geo"]["alias"]) : _link($settings["country_default"]); }else{ echo $_SESSION["geo"]["alias"] ? _link('map/'.$_SESSION["geo"]["alias"]) : _link('map/'.$settings["country_default"]); } ?>" >
                            ...
                            <!--всплывающий список стран и городов -->
                  ...
                  <div class="container-search-geo" >
                      <div class="header-wow-sticky-search" >
                          ...
                          <input type="text" name="search" class="sticky-search-geo-input" autocomplete="off" placeholder="<?php echo $Geo->change()["name"]; ?>" >
