...
class Ads{
            ...
            <?php
              if( $data["ad"]["ads_status"] == 4 ){
                  ...
                  if( $data["order_secure"] ){
                     ...
                     ?>
                      <a class="btn-custom btn-color-light width100" href="<?php echo _link("order/".$data["order_secure"]["secure_id_order"]); ?>"  >
        ...
        <div class="board-view-button">
            ...
            if( $data["ad"]["ads_status"] == 4 ){
                ...
                if( $data["order_secure"] ){
                   ...
                   if( $data["order_secure"]["secure_id_user_buyer"] == $_SESSION["profile"]["id"] ){
                   ?>
                    <a class="btn-custom btn-color-light mb5 width100" href="<?php echo _link("order/".$data["order_secure"]["secure_id_order"]); ?>"  >
                        <span><?php echo $ULang->t("Перейти к заказу"); ?></span><br>
                    </a>
                    <hr>
                   <?php
  ...
  function secureResultPay( $data = [] ){
    ...
    if($getPayment){
        if($getPayment["secure_payments_status_pay"] == 0){
          ...
          <a class="btn-custom-mini btn-color-blue mt5 mb5 width100" href="<?php echo _link("user/".$getUser["clients_id_hash"]."/settings"); ?>" > <span><?php echo $ULang->t("Указать другой счет"); ?></span> </a>
  ...
  function CatalogOutAdGallery($images,$data){
       ...
       if(count($images)){
           ...
           $results .= '<span class="item-grid-count-photo" ><i class="las la-camera"></i> '.count($images).'</span>';
