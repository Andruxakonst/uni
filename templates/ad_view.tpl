       ...
       <div class="board-view-container" >
          ...
          <div class="row" >
              ...
              <div class="col-lg-9" >
                   ...
                   <div class="ads-view-photo" <?php echo $data["image_attr"]; ?> >
                      ...
                      <?php
                        if(count($data["ad"]["ads_images"])){
                            ...
                            if(count($data["ad"]["ads_images"]) > 1){
                                ?>
                                <div class="ads-view-photo-slider lightgallery" <?php echo $data["image_attr"]; ?> >
                                <?php
                                foreach ($data["ad"]["ads_images"] as $key => $value) {
                                   ?>
                                   <a data-thumb="<?php echo Exists($config["media"]["big_image_ads"],$value,$config["media"]["no_image"]); ?>" href="<?php echo Exists($config["media"]["big_image_ads"],$value,$config["media"]["no_image"]); ?>" ><img src="<?php echo Exists($config["media"]["big_image_ads"],$value,$config["media"]["no_image"]); ?>"></a>
                                   <?php
                                }
                                if($data["ad"]["ads_video"]){
                                  ?>
                                  <a data-thumb="<?php echo $settings["path_tpl_image"] . '/youtube.png'; ?>" href="<?php echo clear($data["ad"]["ads_video"]); ?>"  data-type="video" >
                                ...
                                if(!$data["ad"]["ads_video"]){
                                  ...
                                  <div class="lightgallery ads-view-photo-one ads-view-photo-bg-gray" >
                                   ...
                                   <a href="<?php echo Exists($config["media"]["big_image_ads"],$data["ad"]["ads_images"][0],$config["media"]["no_image"]); ?>" ><img src="<?php echo Exists($config["media"]["big_image_ads"],$data["ad"]["ads_images"][0],$config["media"]["no_image"]); ?>"></a>
                   ...
                   <div class="d-block d-lg-none" >
                        ...
                        <div data-id-modal="modal-complaint" class="complain-toggle open-modal text-center mt10" > <span><?php echo $ULang->t("Пожаловаться"); ?></span> </div>
