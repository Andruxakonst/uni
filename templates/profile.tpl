       ...
       <nav aria-label="breadcrumb" class="mt15" >
        ...
        <div class="row" >
           ...
           <div class="col-lg-9 min-height-600" >
               ...
               <!-- Импорт объявлений-->
              <?php if($action == "import" || !$action){ ?>
                <h3 class="mb35 user-title" > <strong><?php echo $data["page_name"]; ?></strong> </h3>
                  <div class="form-group">
                    <a  href="#" data-toggle="modal" data-target="#modal-import" class="btn btn btn-success mr-1 mb-2">Создать импорт</a>
                </div>
                <div class="row" >
                    <div class="col-lg-12" >
                        <div class="widget has-shadow">

                          <div class="widget-body shadow-sm p-3 mb-5 bg-white rounded text-center fs-4">
                                  ...
                                  <?php
                                      ...
                                      <table class="table mb-0">
                                          ...
                                          <?php
                                              ...
                                              ?>
                                              <div class="plug" >
                                                <i style="font-size:70px" class="la la-exclamation-triangle"></i>
                                                <p style="font-size:20px">Импортов нет</p>
                                              </div>
                                          <?php
                  ...
                  <script type="text/javascript" src="/templates/js/jquery.ui.touch-punch.min.js"></script>
              ...
              <?php } ?>
               ...
               <?php
                   ...
                   <div class="user-bg-container mt15" >
                     ...
                     <h4 class="mb35" > <strong><?php echo $ULang->t("Безопасные сделки"); ?></strong> </h4>
                   ...
                   <div class="user-bg-container mt15" >
                     ...
                     <h4 class="mb35" > <strong><?php echo $ULang->t("Бронирование"); ?></strong> </h4>
